...
export const MENUITEMS = [
  {
    ...
    Items: [
      ...
      },
      {
        ...
        active: false,
        children: [
          { path: `${process.env.PUBLIC_URL}/customers/customer-list`, title: "Customer List", type: "link" },
          { path: `${process.env.PUBLIC_URL}/customers/credit-debit`, title: "Credit or Debit", type: "link" },
          { path: `${process.env.PUBLIC_URL}/customers/transactions`, title: "Transactions", type: "link" },
        ]
      },
      {
        title: "Settings",
        ...
        active: false,
        children: [
          { path: `${process.env.PUBLIC_URL}/settings/service-list`, title: "Services", type: "link" }
        ]
      }
    ]
  },
